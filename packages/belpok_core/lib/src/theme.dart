...
/// aren't comfortable with software. Shared by apps/admin and
/// apps/storefront: it's the same brand and the same shopper-facing
/// products either way, just a dashboard vs. a storefront layout around
/// this same identity.
class AppColors {
